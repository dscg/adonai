...
<div class="window-popup">
	<form action="<?=base_url()?>admin/subirVideo" onSubmit="return subir_video(this);" method="post" enctype="multipart/form-data" id="form-video">
		<div class="window">
			...
			<div class="window-content height2row">
				...
				<label for="file" id="file-label"><i class="fas fa-upload"></i> Seleccione Archivo de Video</label>
			</div>
