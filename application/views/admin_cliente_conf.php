...
<div class="container col-12">
 ...
 <ul id="menu-bottom">
	<a class="menu-button icon-plus" href="#menu-bottom" title="Mostrar navegaci&oacute;n"><i class="fas fa-bars fontsize24"></i> &nbsp; Menu</a>
	<a class="menu-button icon-minus" href="#0" title="Ocultar navegaci&oacute;n"><i class="fas fa-times-circle fontsize24"></i> &nbsp; Cerrar</a>
	<li class="menu-item">
	...
	<li class="menu-item">
		<a href="javascript: notificaciones()">
