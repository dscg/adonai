...
<div class="window-popup">
	<form action="<?=base_url()?>admin/crearServicio" onSubmit="return guardar_servicio(this);" method="post" enctype="multipart/form-data" id="form">
		<div class="window">
			<h1 class="window-header"><span class="window-title">Nuevo Producto</span><i class="fas fa-times window-title-icon" onClick="cerrar_ventana_servicio()"></i></h1>
			<div class="window-content height4row scrollableY">
				...
				<input class="width3colmn inputtext" type="text" name="nombre" id="nombre" placeholder="Servicio"/>
				<input class="width3colmn inputtext" type="number" name="precio" id="precio" placeholder="$"/>
				...
				<input class="width2colmn inputtext" type="number" min="0" name="precio_venta" id="precio_compra" required />
				<br/><br/>
